...
Vtm.SeedsHelpers.insert_forum_section(%{title: "Guide", description: "Sezione dedicata alle guide modificate con più frequenza", on_game: false, can_view: true, can_edit: false})
