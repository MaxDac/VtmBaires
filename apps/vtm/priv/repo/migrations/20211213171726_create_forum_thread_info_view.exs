defmodule Vtm.Repo.Migrations.CreateForumThreadInfoView do
  use Ecto.Migration

  def up do
    execute("""
    create view forum_thread_info as
        select distinct on (ft.id)
          ...
          from forum_threads ft
                 ...
                 left join user_forum_notifications cfn on fs.id = cfn.forum_thread_id
