defmodule Vtm.Repo.Migrations.ModifyForumThreadInfoViewForAllowedChars do
  use Ecto.Migration
  ...
  def up do
    ...
    create or replace view forum_thread_info as
        select distinct on (ft.id, ftac.character_id)
              ft.id                        as id
              ,ft.title                     as title
              ,ft.description               as description
              ,ft.highlighted               as highlighted
              ...
              ,ftac.character_id            as allowed_character_id
          ...
          from forum_threads ft
                ...
                left join forum_threads_allowed_characters ftac on ft.id = ftac.forum_thread_id
        order by ft.id, ftac.character_id, fp.updated_at desc
    """)
  end
